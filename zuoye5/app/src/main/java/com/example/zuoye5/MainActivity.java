...
import com.example.zuoye5.UserInfo;
import com.example.zuoye5.UserDBHelper;
import com.example.zuoye5.ViewUtil;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private String mPassword = "18990125"; // 默认密码
...
//        btn_logon = findViewById(R.id.btn_logon);
    ...
    private String[] typeArray = {"家庭", "宿舍", "18990125豆鹏博"};
    // 初始化下拉框
...
//    }
    ...
    private void loginSuccess() {
        ...
        String desc = String.format("您的手机号码是%s，类型是%s。登陆成功，点击“返回”按钮返回上个页面",
